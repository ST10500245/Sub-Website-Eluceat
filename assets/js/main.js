...
(function ($) {
        ...
        $('.countTo_module').each(function () {
            ...
            $(window).scroll(function () {
                ...
                if (a === 0 && scroll + wh > offsettop + wh / 4) {
                    var optData = JSON.parse(self.attr('data-options')),
                        optDefault = {
                            from: 50,
                            to: 2500,
                            speed: 1000,
    ...
    $('.swiper__module').each(function () {
        ...
        var swiper = new Swiper(self[0], options); // Ensure the correct Swiper class is used
        ...
        function thumbnails(selector) {
            if (selector.length > 0) {
                ...
                var swiperThumbs = new Swiper(selector[0], optionsThumbs);
